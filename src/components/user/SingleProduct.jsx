      ...
      <div className="md:flex-1 px-4">
        <div className="h-[460px] rounded-lg bg-slate-50 mb-4 flex items-center justify-center">
          <img
            ...
            src={productData.image? productData.image:'/img/slide4.png'}
            alt="Product Image"
          />
        </div>
      ...
      <div className="md:flex-1 px-4">
        ...
        <div className="flex mb-4">
          <div className="mr-4">
            ...
            <span className="text-gray-600">${productData.market_price}</span>
          </div>
          <div>
            <span className="font-bold text-gray-700">Special Price:</span>
            <span className="text-gray-600">${productData.our_price}</span>
          </div>
        </div>
        <div className="mb-4">
          <span className="font-bold text-gray-700">Availability:</span>
          <span className="text-gray-600">{productData.stock == 0?'Out of stock':'In stock'}</span>
        </div>
