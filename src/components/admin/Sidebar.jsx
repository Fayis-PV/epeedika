...
const Sidebar = () => { 
  ...
  <div className="fixed left-0 top-0 w-64 h-full bg-gray-900 p-4 z-50 sidebar-menu transition-transform">
    <a href="#" className="flex items-center pb-4 border-b border-b-gray-800">
      ...
      />
      <span className="text-lg font-bold text-white ml-5">

      <img src="/img/newlogo.png"  className="w-[50px] h-[50px] ml-8 object-cover" alt="" />
      </span>
    </a>
    <ul className="mt-4">
      ...
      <li className="mb-1 group">
        ...
        >
          ...
          <span        onClick={  () => router.push("/admin/products")}className="text-sm">Products</span>
